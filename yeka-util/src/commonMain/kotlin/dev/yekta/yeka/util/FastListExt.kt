...
/**
 * A collection of extension utilities to help perform slightly faster operations on lists that
 * support random access (particularly ArrayLists).
 * ---
...
/**
 * A variation of [maxOfOrNull] which performs slightly better for lists that have random access.
 * This function **does not assert concurrent modifications**.
 * ---
 * ### CAUTION: Only use if you are sure the list supports random access!
 */
